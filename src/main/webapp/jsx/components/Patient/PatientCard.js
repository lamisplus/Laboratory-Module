            ...
            <Col md={12}>
              <Row className={"mt-1"}>
                ...
                >
                  <span style={{ color: "#000" }}>
                    ...
                    <b style={{ color: "#0B72AA" }}>
                      {patientObj.patientHospitalNumber}
                    </b>
                  </span>
                </Col>
                ...
                >
                  <span style={{ color: "#000" }}>
                    Date Of Birth :{" "}
                    <b style={{ color: "#0B72AA" }}>{patientObj.patientDob}</b>
                  </span>
                </Col>
                <Col
                  md={4}
                ...
                >
                  <span style={{ color: "#000" }}>
                    ...
                    <b style={{ color: "#0B72AA" }}>
                      {calculate_age(
                        moment(patientObj.patientDob).format("DD-MM-YYYY")
                      )}
                    </b>
                  </span>
                </Col>
