...
const PatientSearch = (props) => {
    ...
    const getData = query =>
        new Promise((resolve, reject) => {
             axios.get(`${url}laboratory/orders/pending-sample-verification?searchParam=${query.search}&pageNo=${query.page}&pageSize=${query.pageSize}`, { headers: {"Authorization" : `Bearer ${token}`} })
                    .then(resp => resp)
                    .then(result => {
